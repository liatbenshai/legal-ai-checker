...
async function transcribeChunk(
  ...
  const response = await openai.audio.transcriptions.create({
    ...
    language: "he",
    prompt:
      "פרוטוקול דיון בבית משפט בישראל. " +
      "דוברים: שופט, עורך דין, עד, נאשם, תובע, פרקליט. " +
      ...
      "שמות: כהן, לוי, ישראלי, מזרחי, פרידמן, גולדשטיין, זמישלני. " +
      "מונחים רפואיים ומדעיים: פרופסיה, סומטית, לונגיטודינליות, אנמנזה, " +
      "פתולוגיה, אטיולוגיה, קוגניטיבי, רטרואקטיבי, אמבולטורי, " +
      "דיפרנציאלית, אפידמיולוגי, פרוגנוזה. " +
      "שמור על היסוסים ומילות מילוי כמו שהם.",
  });
